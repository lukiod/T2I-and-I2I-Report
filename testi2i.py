...
CONTROLNET = None
STEPS = 30
PROMPT = "make it into a painting"
NEGATIVE_PROMPT = ""
SEED = 333
WARMUPS = 1
BATCH = 1
...
def parse_args():
    ...
    parser.add_argument("--input-image", type=str, required=True, default=INPUT_IMAGE)
...
def main():
    ...
    from diffusers import  StableDiffusionInstructPix2PixPipeline as piplinecls
